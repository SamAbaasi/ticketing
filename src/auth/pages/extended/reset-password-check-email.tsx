  ...
  return (
    <div className="card max-w-[440px] w-full">
      <div className="card-body p-10">
        ...
        <h3 className="text-lg font-medium text-mono text-center mb-3">Check your email</h3>
        <div className="text-sm text-center text-secondary-foreground mb-7.5">
          Please click the link sent to your email{' '}
          <a href="#" className="text-sm text-foreground font-medium hover:text-primary-active">
            {email}
          </a>
          <br />
        ...
        <div className="flex items-center justify-center gap-1">
          <span className="text-xs text-secondary-foreground">Didn’t receive an email?</span>
          <Link
            to={
              settings?.layout === 'auth-branded'
