  ...
  return (
    <div className="flex flex-col gap-5 p-10">
      ...
      <div className="text-center mb-2">
        <h3 className="text-lg font-medium text-mono mb-5">Verify your phone</h3>
      ...
      <div className="flex items-center justify-center mb-2">
        ...
        <Link to="/auth/classic/login" className="font-semibold text-foreground hover:text-primary">
          Resend
        </Link>
      </div>
