...
const ResetPasswordChanged = () => {
  ...
  return (
    <div className="px-4 py-8">
      ...
      <h3 className="text-lg font-medium text-mono text-center mb-4">Your password is changed</h3>
      <div className="text-sm text-center text-secondary-foreground mb-7.5">
        Your password has been successfully updated. Your account's security is our priority.
      </div>

      <Button asChild className="w-full">
        <Link to={settings?.layout === 'auth-branded' ? '/auth/signin' : '/auth/classic/signin'}>
          Sign in
        </Link>
      </Button>
    </div>
